...
#define _LOG_SET(_severity) boost::log::core::get()->set_filter(boost::log::trivial::severity >= boost::log::trivial::_severity)
...
#define _LOG(_severity)     BOOST_LOG_SEV(RenderStudio::logger::get(), boost::log::trivial::_severity) << boost::log::add_value("Function", _FUNCTION_NAME) << boost::log::add_value("Line", static_cast<unsigned long>(__LINE__))
